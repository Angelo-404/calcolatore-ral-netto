...
- **Le opzioni di dettaglio stanno in una tendina, non sparite.** Giorni e tipo di buono, modalità di erogazione del premio, contributo del datore e destinazione del TFR: sono nove controlli che a riposo non hanno nulla su cui agire. Nasconderli del tutto li avrebbe resi irraggiungibili — un campo invisibile non si compila — quindi restano dietro una riga con la freccia, sempre apribile. Si apre da sola quando la voce da cui dipende acquista un valore, compilato a mano o portato da un link condiviso; e se è stata aperta a mano resta aperta, perché richiuderla a ogni ricalcolo sarebbe un dispetto.
